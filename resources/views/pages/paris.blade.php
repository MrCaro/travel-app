...
@section ('content')
    ...
    <div class="home-banner text-center">
        <img id="home-banner-img-responsive" src="{{url('/images/paris-banner-bg.png')}}" alt="" style="width: 100vw; height: 100vh;">
        <div id="destinations-banner-blur-responsive-paris" class="d-none d-sm-block">
        </div>
        {{-- desktop --}}
        {{-- title --}}
